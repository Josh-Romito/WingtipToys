...
public class NVPAPICaller
{
    ...
    public string APIUsername = "jromito71-facilitator_api1.gmail.com";
    private string APIPassword = "RFEML2VRJRVTC7TJ";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A3aQI62K9jOzd6JT-ke3y0sM8kE4";
   ...
   retMsg)
    {
        ...
        string returnURL = "http://localhost:49738/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:49738/Checkout/CheckoutCancel.aspx";
       ...
       "successwithwarning"))
        {
            token = decoder["TOKEN"];
            string ECURL = "https://" + host + "/cgi-bin/webscr?cmd=_expresscheckout"
           + "&token=" + token;
            retMsg = ECURL;
            return true;
        }
